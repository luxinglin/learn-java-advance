...
import cn.com.gary.database.common.util.PageUtil;
...
public class ProductServiceImpl extends ServiceImpl<ProductMapper, Product> implements ProductService {
    ...
    public IPage<Product> advPage(Page<Product> page, Product product) {
        ...
        //构造分页查询参数
        params.put(PageConstant.ORDER_BY_CLAUSE, PageUtil.constructOrderClause(page));
        //处理时间段查询条件
        ...
        return PageUtil.getIPageResult(pageInfo, page, list);
    }
}
